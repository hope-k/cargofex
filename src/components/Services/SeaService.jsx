      ...
      <div className=" relative top-[7rem]">
        ...
        >
          ...
          <motion.h3 variants={variant} className="text-gray-300 text-lg">
            Our Ocean Freight service offers cost-effective, eco-friendly<br/>
            solutions for shipping your goods across the globe. Leveraging<br/>
            partnerships with major carriers, we ensure secure, reliable sea<br/>
            transport.
          </motion.h3>
